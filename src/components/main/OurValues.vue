...
<template>
    <section>
        <div>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio omnis quod provident voluptatem molestias perferendis.</p>
        </div>
        <div v-for="(element, index) in values" :key="index">
